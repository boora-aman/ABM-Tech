...
export const FIELDS: Record<string, Field[]> = {
  ...
  industries: [
    ...
    { name: "seoTitle", label: "SEO title", type: "text", hint: "Search-voice <title> for /industries/[slug] — falls back to Name if left blank" },
    { name: "keywords", label: "Keywords", type: "list", rows: 4, hint: "One per line — meta keywords + internal reference, not a ranking factor on its own" },
    ...
    { name: "intro", label: "Intro paragraph", type: "textarea", hint: "Opening paragraph on the detail page — needs to stand alone as the answer to the page's own question" },
    { name: "outcome", label: "Outcome", type: "text", hint: "One sentence: what changes once this is running" },
    { name: "faqs", label: "FAQs (JSON)", type: "json", hint: '[{"q":"…","a":"…"}]' },
  ...
  pillars: [
    ...
    { name: "seoTitle", label: "SEO title", type: "text", hint: "Search-voice <title> for /systems/[key]" },
    { name: "keywords", label: "Keywords", type: "list", rows: 3 },
    { name: "intro", label: "Intro paragraph", type: "textarea", hint: "Opening paragraph on the pillar detail page" },
    { name: "faqs", label: "FAQs (JSON)", type: "json", hint: '[{"q":"…","a":"…"}]' },
    ...publishing,
  ],
  ...
  projects: [
    ...
    { name: "industrySlug", label: "Industry slug", type: "text", hint: "Optional — only set where a real sector match exists in content/industries.ts" },
    ...publishing,
  ],
